...
@questions.route('/<int:blog_post_id>')
...
@questions.route("/<int:blog_post_id>/update", methods=['GET', 'POST'])
@login_required
def update(blog_post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Post Updated')
        return redirect(url_for('questions.blog_post', blog_post_id=blog_post.id))
...
@questions.route("/<int:blog_post_id>/delete", methods=['POST'])
@login_required
